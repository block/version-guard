...
3. User provides:
   ...
   - Wiz report ID: `7bac4838-cf54-46c4-93a2-f63cced1735a`
4. Detects schema from existing config entries
5. Generates config with `id: aurora-postgresql` and `schema: standard`
6. Appends to config/resources.yaml
7. Runs `go test ./pkg/detector/generic -v` ✅
8. Creates commit ✅
9. Reminds user to add to WIZ_REPORT_IDS: `{"aurora-postgresql":"7bac4838-..."}`
